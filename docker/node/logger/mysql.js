...
if (!fs.existsSync(path.join(rootPath, 'logs', 'mysql'))) {
  fs.mkdirSync(path.join(rootPath, 'logs', 'mysql'))
  fs.writeFileSync(path.join(rootPath, 'logs', 'mysql', '.gitignore'), '*\n!.gitignore')
}

// create a rotating write stream
const accessLogStream = rfs.createStream('access.log', {
  interval: process.env.LOG_INTERVAL, // rotate daily
  path: path.join(rootPath, 'logs', 'mysql'),
